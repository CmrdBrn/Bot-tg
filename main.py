#Бота создал @ATrild все вопросы в лс
# -*- coding: utf-8 -*-
import telebot
...
4 - Бот в сразу вышлет: фото клада в близи/фото клада отдалёно/точные координаты</b>
...
📢Обращаться - @ATrild""",parse_mode='HTML', reply_markup=keyboards.keyboardMain)
